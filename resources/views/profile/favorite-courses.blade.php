...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/profile/fav.css') }}">
    ...
    <div class="main-content">
        ...
        @else
            <div class="no-courses-message">
                ...
                <h2>No Favorite Courses Found</h2>
                <p>It looks like you haven't added any courses to your favorites yet. Start exploring and add some!</p>
